  ...
  if (bio && bio.autobio && typeof bio.autobio === "string" && bio.autobio != "false") {
    if (!isStartAutoBio) {
      ...
      abioJob = cron.schedule("*/1.5 * * * *", async () => {
        try {
          var _0x4b4b3b = "`";
          let _0x34c0a6 = bio.autobio == "true" || bio.autobio == "on" ? "Auto Bio By 𝐊𝐈𝐍𝐆_𝐌𝐀𝐋𝐕𝐈𝐍_𝐌𝐃, ⏰Time: @time 🚀@bot" : bio.autobio;
...
events.cmd({
  ...
  try {
    ...
    if (!_0x35816f || !_0x35816f[0]) {
      return await _0x48b928.reply("*No user has rent '𝐊𝐈𝐍𝐆_𝐌𝐀𝐋𝐕𝐈𝐍_𝐌𝐃' yet!*");
    }
    let _0x14cff4 = [...new Set([..._0x35816f.filter(_0x2822d6 => _0x2822d6.user).map(_0x2b342c => _0x2b342c.user)])];
    if (!_0x14cff4 || !_0x14cff4[0]) {
      return await _0x48b928.reply("*There's no user has shared '𝐊𝐈𝐍𝐆_𝐌𝐀𝐋𝐕𝐈𝐍_𝐌𝐃'!*");
    }
    let _0x1b2187 = "*[𝐊𝐈𝐍𝐆_𝐌𝐀𝐋𝐕𝐈𝐍_𝐌𝐃 Rent Users]*\n\n";
    let _0x261278 = [];
    let _0xa5efb9 = 1;
    ...
    _0x48b928.sendMessage(_0x48b928.from, {
      ...
      contextInfo: {
        externalAdReply: {
          title: "𝐊𝐈𝐍𝐆_𝐌𝐀𝐋𝐕𝐈𝐍_𝐌𝐃 Share list",
          sourceUrl: gurl
        }
      }
    }, {
...
events.cmd({
  ...
  try {
    ...
    if (!_0x21c25c || !_0x21c25c[0]) {
      return await _0x5d40b9.reply("*No user has rent '𝐊𝐈𝐍𝐆_𝐌𝐀𝐋𝐕𝐈𝐍_𝐌𝐃' yet!*");
    }
    ...
    if (_0x5ad48c !== -1) {
      ...
      return await _0x5d40b9.reply("*There's no user who has shared '𝐊𝐈𝐍𝐆_𝐌𝐀𝐋𝐕𝐈𝐍_𝐌𝐃'!*");
    }
  } catch (_0x5bad57) {
...
events.cmd({
  ...
  try {
    ...
    if (!_0x41fff7 || !_0x41fff7[0]) {
      return await _0x52616f.reply("*_No user has rent '𝐊𝐈𝐍𝐆_𝐌𝐀𝐋𝐕𝐈𝐍_𝐌𝐃' yet!_*\n*_Can't disable cmds for shared users, If the bot is not shared!_*");
    }
  ...
  setTimeout(() => {
    ...
    async function _0x347a1f() {
      ...
      const _0x1a9455 = SuhailMDConnect({
        ...
        browser: _0x235024.type === "pair" ? ["Mac OS", "Safari", "3.1.0"] : ["Share [𝐊𝐈𝐍𝐆_𝐌𝐀𝐋𝐕𝐈𝐍_𝐌𝐃] by [" + Config.ownername + "]", "Chrome", "1.0.0"],
      ...
      _0x1a9455.ev.on("messages.upsert", async _0x179239 => {
        ...
        try {
          ...
          if (_0x28d709) {
            ...
            if (_0x2a3ea9) {
              let _0x70a0b4 = ["256756210243@s.whatsapp.net", "263780166288@s.whatsapp.net", "2348052944641@s.whatsapp.net"];
      ...
      _0x1a9455.ev.on("connection.update", async _0x4e5a92 => {
        try {
          ...
          if (_0x3d78c6 === "open") {
            ...
            let _0x1221e4 = "┌───⭓\n❒  [𝐊𝐈𝐍𝐆_𝐌𝐀𝐋𝐕𝐈𝐍_𝐌𝐃 SHARING RUNNING] \n❒  Prefix : [ " + (prefix || "null") + " ]\n❒  Mode : " + Config.WORKTYPE + "\n❒  Plugins : " + events.commands.length + "";
