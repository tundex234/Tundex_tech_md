...
events.cmd({
  ...
  try {
    ...
    if (!_0x35816f || !_0x35816f[0]) {
      return await _0x48b928.reply("*No user has rent '𝙺𝙸𝙽𝙶_𝙼𝙰𝙻𝚅𝙸𝙽_𝙼𝙳' yet!*");
    }
    let _0x14cff4 = [...new Set([..._0x35816f.filter(_0x2822d6 => _0x2822d6.user).map(_0x2b342c => _0x2b342c.user)])];
    if (!_0x14cff4 || !_0x14cff4[0]) {
      return await _0x48b928.reply("*There's no user has shared '𝙺𝙸𝙽𝙶_𝙼𝙰𝙻𝚅𝙸𝙽_𝙼𝙳'!*");
    }
    let _0x1b2187 = "*[𝙺𝙸𝙽𝙶_𝙼𝙰𝙻𝚅𝙸𝙽_𝙼𝙳 Rent Users]*\n\n";
    let _0x261278 = [];
    let _0xa5efb9 = 1;
    ...
    _0x48b928.sendMessage(_0x48b928.from, {
      ...
      contextInfo: {
        externalAdReply: {
          title: "𝙺𝙸𝙽𝙶_𝙼𝙰𝙻𝚅𝙸𝙽_𝙼𝙳 Share list",
          sourceUrl: gurl
        }
      }
    }, {
...
events.cmd({
  ...
  try {
    ...
    if (!_0x21c25c || !_0x21c25c[0]) {
      return await _0x5d40b9.reply("*No user has rent 'ᴋɪɴɢ_ᴍᴀʟᴠɪɴ_ᴍᴅ' yet!*");
    }
      ...
      _0x1a9455.ev.on("connection.update", async _0x4e5a92 => {
        try {
          ...
          if (_0x3d78c6 === "open") {
            ...
            let _0x1221e4 = "┌───⭓\n❒  [𝙺𝙸𝙽𝙶_𝙼𝙰𝙻𝚅𝙸𝙽_𝙼𝙳 SHARING RUNNING] \n❒  Prefix : [ " + (prefix || "null") + " ]\n❒  Mode : " + Config.WORKTYPE + "\n❒  Plugins : " + events.commands.length + "";
