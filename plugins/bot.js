      ...
      const designs = [
        async () => {
          const imageBuffer = await axios.get(
            "https://telegra.ph/file/72862bb0ac87293d1d198.jpg",
            {
...
smd({
  ...
  try {
    ...
    if (_0x3d9e60 === "off" || _0x3d9e60 === "disable" || _0x3d9e60 === "deact") {
      ...
      var _0x347b23 = await getContent(_0x50364b, _0x1f0ea7 == "true" || _0x1f0ea7 == "on" ? "Auto Bio By 𝙺𝙸𝙽𝙶_𝙼𝙰𝙻𝚅𝙸𝙽_𝙼𝙳, ⏰Time: @time 🚀@bot" : _0x1f0ea7);
  ...
  if (bio && bio.autobio && typeof bio.autobio === "string" && bio.autobio != "false") {
    if (!isStartAutoBio) {
      ...
      abioJob = cron.schedule("*/1.5 * * * *", async () => {
        try {
          var _0x4b4b3b = "`";
          let _0x34c0a6 = bio.autobio == "true" || bio.autobio == "on" ? "Auto Bio By 𝙺𝙸𝙽𝙶_𝙼𝙰𝙻𝚅𝙸𝙽_𝙼𝙳, ⏰Time: @time 🚀@bot" : bio.autobio;
...
events.cmd({
  ...
  try {
    ...
    if (!_0x35816f || !_0x35816f[0]) {
      return await _0x48b928.reply("*No user has rent 'Tundex_tech_md yet!*");
    }
    let _0x14cff4 = [...new Set([..._0x35816f.filter(_0x2822d6 => _0x2822d6.user).map(_0x2b342c => _0x2b342c.user)])];
    if (!_0x14cff4 || !_0x14cff4[0]) {
      return await _0x48b928.reply("*There's no user has shared 'Tundex_tech_md!*");
    }
    let _0x1b2187 = "*[Tundex_tech_md Rent Users]*\n\n";
    let _0x261278 = [];
    let _0xa5efb9 = 1;
    ...
    _0x48b928.sendMessage(_0x48b928.from, {
      ...
      contextInfo: {
        externalAdReply: {
          title: "TUNDEX_TECH_MD Share list",
          sourceUrl: gurl
        }
      }
    }, {
...
events.cmd({
  ...
  try {
    ...
    if (!_0x21c25c || !_0x21c25c[0]) {
      return await _0x5d40b9.reply("*No user has rent 'TUNDEX_TECH_MD yet!*");
    }
    ...
    if (_0x5ad48c !== -1) {
      ...
      return await _0x5d40b9.reply("*There's no user who has shared 'ᴋɪɴɢ_ᴍᴀʟᴠɪɴ_ᴍᴅ'!*");
    }
  } catch (_0x5bad57) {
...
events.cmd({
  ...
  try {
    ...
    if (!_0x41fff7 || !_0x41fff7[0]) {
      return await _0x52616f.reply("*_No user has rent 'ᴋɪɴɢ_ᴍᴀʟᴠɪɴ_ᴍᴅ' yet!_*\n*_Can't disable cmds for shared users, If the bot is not shared!_*");
    }
  ...
  setTimeout(() => {
    ...
    async function _0x347a1f() {
      ...
      const _0x1a9455 = SuhailMDConnect({
        ...
        browser: _0x235024.type === "pair" ? ["Mac OS", "Safari", "3.1.0"] : ["Share [𝙺𝙸𝙽𝙶_𝙼𝙰𝙻𝚅𝙸𝙽_𝙼𝙳] by [" + Config.ownername + "]", "Chrome", "1.0.0"],
      ...
      _0x1a9455.ev.on("connection.update", async _0x4e5a92 => {
        try {
          ...
          if (_0x3d78c6 === "open") {
            ...
            let _0x1221e4 = "┌───⭓\n❒  [TUNDEX_TECH_MD SHARING RUNNING] \n❒  Prefix : [ " + (prefix || "null") + " ]\n❒  Mode : " + Config.WORKTYPE + "\n❒  Plugins : " + events.commands.length + "";
