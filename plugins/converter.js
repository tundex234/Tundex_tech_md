...
smd({
  ...
  try {
    ...
    let _0x20f704 = _0x44d3dd[1] && _0x44d3dd[1] !== "" ? _0x44d3dd[1] : "𝙺𝙸𝙽𝙶_𝙼𝙰𝙻𝚅𝙸𝙽_𝙼𝙳 ♥️";
...
smd({
  ...
  try {
    let _0x365550 = "┏━━━━━━━━━━━━━━━━━━━━━━━━\n┃\t*💬KING_MALVIN_MD_FANCY_TEXT💬* \n┗━━━━━━━━━━━━━━━━━━━━━━━━\n\n " + (_0x3b568a ? "```🔢Reply the number you wants to select``` \n\n" : "```\t\t" + prefix + "fancy KING_MALVIN_MD(For all text)\n\t\t" + prefix + "fancy 25 KING_MALVIN_MD(For specific text)```\n\n");
    let _0x50c7d9 = parseInt(_0x3b568a);
    if (isNaN(_0x50c7d9)) {
      let _0x4ca942 = _0x3b568a ? _0x3b568a : "KING_MALVIN_MD";
...
smd({
  ...
  try {
    ...
    if (!_0xd51ec) {
      return _0x4cfc4e.reply("*_Example : " + prefix + "fliptext KING_MALVIN_MD!_*");
    }
...
smd({
  ...
  try {
    ...
    if (_0x2cee76) {
      ...
      return _0x54e3dc.reply("*_Uhh Dear, provide text, ex .ttp 4 hii im KING_MALVIN_MD!!_*");
    }
  } catch (_0x72e5d) {
