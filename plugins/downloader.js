...
smd({
  ...
  try {
    ...
    if (!_0x1c586e) {
      return await _0x1ae8f8.reply("*Provide Repo Url, _.gitclone https://github.com/malvinking/King_Malvin_Md_*");
    }
...
smd({
  ...
  try {
    ...
    if (!_0x204f81) {
      return _0x55aba2.reply("*_Example : .tts Hi,I am 𝐊𝐈𝐍𝐆_𝐌𝐀𝐋𝐕𝐈𝐍_𝐌𝐃 whatsapp bot._*");
    }
    try {
...
smd({
  ...
  try {
    ...
    try {
      ...
      let _0x3448d2 = _0x4e4465.title || _0x3e3caf || _0x421809[1] || "𝐊𝐈𝐍𝐆_𝐌𝐀𝐋𝐕𝐈𝐍_𝐌𝐃 -- YT Video";
      if (_0x3e3caf) {
...
smd({
  ...
  try {
    ...
    let _0x4737bb = {
      audio: _0x2ba501,
      fileName: "𝐊𝐈𝐍𝐆_𝐌𝐀𝐋𝐕𝐈𝐍_𝐌𝐃 tiktok Sound" + _0x19c223 + ".m4a",
      mimetype: "audio/mpeg",
      ptt: true,
...
smd({
  ...
  try {
    ...
    let _0x300d1a = {
      ...
      mimetype: "audio/mpeg",
      fileName: "𝐊𝐈𝐍𝐆_𝐌𝐀𝐋𝐕𝐈𝐍_𝐌𝐃--" + _0x1d542b[1] + ".mp3",
      caption: Config.caption,
...
cmd({
  ...
  if (_0xb75e78.quoted && _0xb75e78.text) {
    ...
    if (_0x5b8ee5[0].includes("𝐊𝐈𝐍𝐆_𝐌𝐀𝐋𝐕𝐈𝐍_𝐌𝐃 • SONG DOWNLOADER")) {
    ...
    } else if (_0x5b8ee5[0].includes("𝐊𝐈𝐍𝐆_𝐌𝐀𝐋𝐕𝐈𝐍_𝐌𝐃 • YOUTUBE DOWNLOADER")) {
